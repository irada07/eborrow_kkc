                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form action=" {{ route('reports.goods.show') }}" method="GET" id="goodExport"  form="goodExport">
                                ...
                                <input id="year_number" type="number" id="year" name="year" form="goodExport" class="form-control" required>
                                <br>
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <form action=" {{ route('reports.goods.show2') }}" method="GET" id="goodExport2"  form="goodExport2">
                            <br>
                            <label for="">ประจำปีงบประมาณ : </label>
                            <input id="year_number2" type="number" id="year" name="year" form="goodExport2" class="form-control" required>
                            <br>
...
const myElement = document.getElementById("year_number");
myElement.value = new Date().getFullYear() +543;

const myElement2 = document.getElementById("year_number2");
myElement2.value = new Date().getFullYear() +543;
</script>
@stop
