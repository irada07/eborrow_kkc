                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form action=" {{ route('reports.teaching-mats.show2') }}" method="GET" id="matExport2"  form="matExport2">
                                ...
                                <input id="year_number" type="number" id="year" name="year" form="matExport2" class="form-control" required>
                                <br>
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <form action=" {{ route('reports.teaching-mats.show') }}" method="GET" id="matExport"  form="matExport">
                            <br>
                            <label for="">ประจำปีงบประมาณ : </label>
                            <input id="year_number2" type="number" id="year" name="year" form="matExport" class="form-control" required>
                            <br>
