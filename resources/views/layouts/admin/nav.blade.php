<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="">
                <a href="{{ url('/admin') }}"><i class="fa-solid fa-house"></i> <span class="nav-label">หน้าแรก</span> </a>
            </li>
            ...
            <li class="{{ route::is('access.*') ? 'active' : '' }}">
                ...
                <ul class="nav nav-second-level">
                    <li class="{{ route::is('access.approve') ? 'active' : '' }}">
                        <a href="{{ route('access.approve') }}">ผู้ใช้งานใหม่ <span class="label label-warning pull-right numUser">  </span></a>
                    </li>
                    <li class="{{ route::is('access.index') ? 'active' : '' }}">
                        <a href="{{ route('access.index') }}">ผู้ใช้งานทั้งหมด</a>
                    </li>
                </ul>
            </li>
