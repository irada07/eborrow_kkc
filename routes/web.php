...
//STATUS
Route::get('/checkstatus', 'User\UserController@checkstatus')->name('checkstatus');
Route::get('/checkadmin', 'User\UserController@checkadmin')->name('checkadmin');
...
Route::group(['middleware' => ['admin']], function(){
    ...
    //Materials
    Route::get('/admin/materials/borrow', 'User\MaterialUserController@index')->name('materials.index');
    Route::post('/admin/materials/show-materials', 'User\MaterialUserController@showMaterials')->name('materials.show');
    Route::post('/admin/materials/order', 'User\MaterialUserController@orderMaterial')->name('materials.order');
    Route::get('/admin/materials/history', 'User\MaterialUserController@history')->name('materials.history');
    Route::post('/admin/materials/show-histories', 'User\MaterialUserController@showHistory')->name('materials.show.history');

    Route::get('/admin/teaching-materials/borrow', 'User\TeachingMaterialUserController@index')->name('teaching-materials.index');
    Route::post('/admin/teaching-materials/show-materials', 'User\TeachingMaterialUserController@showMaterials')->name('teaching-materials.show');
    Route::post('/admin/teaching-materials/order', 'User\TeachingMaterialUserController@orderMaterial')->name('teaching-materials.order');
    Route::get('/admin/teaching-materials/history', 'User\TeachingMaterialUserController@history')->name('teaching-materials.history');
    Route::post('/admin/teaching-materials/show-histories', 'User\TeachingMaterialUserController@showHistory')->name('teaching-materials.show.history');
    //Goods
    Route::get('/admin/goods/borrow', 'User\GoodUserController@index')->name('goods.index');
    Route::post('/admin/goods/show-goods', 'User\GoodUserController@showGoods')->name('goods.show');
    Route::post('/admin/goods/order', 'User\GoodUserController@orderGood')->name('goods.order');
    Route::get('/admin/goods/history', 'User\GoodUserController@history')->name('goods.history');
    Route::post('/admin/goods/show-histories', 'User\GoodUserController@showHistory')->name('goods.show.history');

    //Access
    Route::get('/access', 'Admin\AccessController@index')->name('access.index');
    Route::get('/access/allusers', 'Admin\AccessController@showUsers')->name('access.show');
    Route::post('/access/manage', 'Admin\AccessController@manageUser')->name('access.manage');
    Route::get('/access/approve', 'Admin\AccessController@approve')->name('access.approve');
    Route::get('/access/listapproveusers', 'Admin\AccessController@listApproveUsers')->name('access.listapproveusers');
    Route::post('/access/activeuser', 'Admin\AccessController@activeUser')->name('access.activeuser');
    Route::post('/access/deactiveuser', 'Admin\AccessController@deactiveUser')->name('access.deactiveuser');

    Route::post('/countUserApprove', 'Admin\AdminController@countUserApprove');
    ...
    Route::post('/manage-goods/change', 'Admin\GoodAdminController@changeStatusGood')->name('manage-goods.change');
    ...
    Route::post('/manage-materials/change', 'Admin\MaterialAdminController@changeStatusMaterial')->name('manage-materials.change');
    ...
    Route::post('/manage-teaching-materials/change', 'Admin\TeachingMaterialAdminController@changeStatusTeachingMaterial')->name('manage-teaching-materials.change');
